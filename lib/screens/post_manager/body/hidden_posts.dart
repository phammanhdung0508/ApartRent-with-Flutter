...
class PostHiddenId {
  ...
  PostHiddenId(this.id);
}

class HiddenPosts extends StatefulWidget {
  const HiddenPosts({Key? key}) : super(key: key);

  @override
  _HiddenPosts createState() => _HiddenPosts();
}

class _HiddenPosts extends State<HiddenPosts> {
            ...
            return ListView.separated(
                ...
                itemBuilder: (context, index) {
                  return GestureDetector(
                    onTap: () {
                      Navigator.pushNamed(context, HiddenDetailScreen.routeName,
                              arguments:
                                  PostHiddenId(snapshot.data![index].postId))
                          .then((_) => {
                                setState((() {
