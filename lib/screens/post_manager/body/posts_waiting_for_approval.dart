...
class PostWaitingId {
  ...
  PostWaitingId(this.id);
}

class PostsWaitingForApproval extends StatefulWidget{
  const PostsWaitingForApproval({Key? key}) : super(key: key);

  @override
  _PostsWaitingForApproval createState() => _PostsWaitingForApproval();
}

class _PostsWaitingForApproval extends State<PostsWaitingForApproval>{
